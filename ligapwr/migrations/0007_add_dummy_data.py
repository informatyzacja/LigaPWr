...
def add_dummy_data(apps, schema_editor):
    Sport = apps.get_model('ligapwr', 'Sport')
    Edition = apps.get_model('ligapwr', 'Edition')
    SportGlobalPoints = apps.get_model('ligapwr', 'SportGlobalPoints')
    Team = apps.get_model('ligapwr', 'Team')
    Department = apps.get_model('ligapwr', 'Department')
    Match = apps.get_model('ligapwr', 'Match')
